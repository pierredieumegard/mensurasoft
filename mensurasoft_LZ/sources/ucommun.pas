...
const
  ...
  ouicalibrationp:boolean=false;
  ouicalibrationa:boolean=false;
  ouicalibrations:boolean=false;
...
var
  stdneadp, stdneada, stdneads: function(n: longint): PChar; stdcall;

var
  stdeadp, stdeada, stdeads: function(n: longint): double; stdcall;

var
  stdsad: function(n: longint; valeur: double): double; stdcall;

var
  stdsaf: function(n: longint; valeur: double): double; stdcall;
  var stdsav : function (n:longint;valeur:double):double;stdcall;

var
  stdnsad: function(n: longint): PChar; stdcall;

var
  stdeb: function(n: longint): longint; stdcall;

var
  stdneb: function(n: longint): PChar; stdcall;

var
  stdsb: function(n: longint; valeur: longint): longint; stdcall;

var
  stdnsb: function(n: longint): PChar; stdcall;

var
  stdnsaf: function(n: longint): PChar; stdcall;
  var stdnsav:function(n:longint):pchar;stdcall;

var
  stddetailp, stddetaila, stddetails, stddetailsaf: function(): PChar; stdcall;
  stddetailsb:function():pchar;stdcall;
  stdtitresb:function():pchar;stdcall;
  stdtitresav:function():pchar;stdcall;
  stddetailsav:function():pchar;stdcall;
    stdcalibrationp:function(ch:pchar):pchar;stdcall;
  stdcalibrationa:function(ch:pchar):pchar;stdcall;
  stdcalibrations:function(ch:pchar):pchar;stdcall;

var
  stdtitrep, stdtitrea, stdtitres, stdtitresaf: function(): PChar; stdcall;
 //var fonctionp,fonctiona,fonctions:fonction;
 //var stdtitrep:function():ansistring;stdcall;
...
begin
  ...
  stdcalibrationp:=basestdcalibrationp;
...
begin
  ...
  stdcalibrationa:=basestdcalibrationa;
...
begin
  ...
  stdneads   := basestdneads;
   stdcalibrations:=basestdcalibrations;
