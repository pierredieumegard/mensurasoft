...
var basestdcalibrationp, basestdcalibrationa,basestdcalibrations:function(ch:pchar):pchar;stdcall;
...
basemabibdynp:=LoadLibrary(nomfich);
  ...
  pointer(basestdeadp):=getprocaddress(basemabibdynp,'stdead');
      ...
      pointer(basestdtitrep):=getprocaddress(basemabibdynp,'stdtitre');
        pointer(basestdcalibrationp):=getprocaddress(basemabibdynp,'stdcalibration');
      if pointer(basestdcalibrationp)<>nil then ouicalibrationp:=true else ouicalibrationp:=false;
...
basemabibdyna:=LoadLibrary(nomfich);
  ...
  pointer(basestdeada):=getprocaddress(basemabibdyna,'stdead');
      ...
      pointer(basestdtitrea):=getprocaddress(basemabibdyna,'stdtitre');
       pointer(basestdcalibrationa):=getprocaddress(basemabibdyna,'stdcalibration');
      if pointer(basestdcalibrationa)<>nil then ouicalibrationa:=true else ouicalibrationa:=false;
...
basemabibdyns:=LoadLibrary(nomfich);
  ...
  pointer(basestdeads):=getprocaddress(basemabibdyns,'stdead');
      ...
      pointer(basestdcalibrations):=getprocaddress(basemabibdyns,'stdcalibration');
      if pointer(basestdcalibrations)<>nil then ouicalibrations:=true else ouicalibrations:=false;
